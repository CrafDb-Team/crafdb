...
INSERT INTO 'Customer' ( 'Name', 'Email', 'ContactNumber') VALUES 
('Buzzbean', 'dvasyukhnov0@devhub.com', '+27 596 515 9541'),
('Feednation', 'stiley1@squarespace.com', '+27 869 343 1241'),
('Thoughtstorm', 'mskudder2@shutterfly.com', '+27 940 597 9707'),
('Gabspot', 'ddiiorio3@unicef.org', '+27 319 479 6848'),
('Zoonoodle', 'jeveritt4@jiathis.com', '+27 678 635 4212'),
('Vidoo', 'bwedderburn5@goo.gl', '+27 484 577 1646'),
('Photospace', 'obarajaz6@marriott.com', '+27 415 553 9464'),
('Voonte', 'vdyett7@omniture.com', '+27 659 477 5898'),
('Livetube', 'tconnachan8@ucla.edu', '+27 937 829 9865'),
( 'Kaymbo', 'geades9@naver.com', '+27 575 798 1979');
-- rollback DELETE FROM TABLE "Customer";

-- changeset lbradford:table-order-insertion
INSERT INTO 'Order' ( 'CustomerID', 'CreatedOn') VALUES 
(1, '2023-08-25'),
(1, '2023-08-16'),
(1, '2023-09-21'),
(3, '2023-07-05'),
...
(5, 6),
(4, 4);
-- rollback DELETE FROM TABLE "Batch";
